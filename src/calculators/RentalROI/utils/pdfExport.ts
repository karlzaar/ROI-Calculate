...
export function generateRentalROIPDF(options: PDFExportOptions): void {
  ...
  doc.setFont('helvetica', 'bold');
  doc.text('ROI Calculate', margin + logoSize + 4, yPos + 6);
  doc.setTextColor(...COLORS.primary);
  doc.setFontSize(FONT.xs);
  doc.setFont('helvetica', 'normal');
  doc.text('Analyze rental property investments with 10-year cash flow projections & returns', margin + logoSize + 4, yPos + 11);
